...
class Record(object):
    ...
    def to_dict(self, conversion = None, ordered=False):
        ...
        if conversion:
            for key, func in conversion.items():
                result_dict[key] = func(result_dict[key])
...
class RecordCollection(object):
    ...
    def all(self, conversion = None, to_dict=False, as_ordereddict=False):
        ...
        if to_dict:
            return [r.to_dict(conversion) for r in rows]
        elif as_ordereddict:
            return [r.to_dict(conversion,ordered=True) for r in rows]

        return rows

    def to_dict(self, conversion = None, ordered=False):
        return self.all(conversion, to_dict=not(ordered), as_ordereddict=ordered)

    def first(self, conversion = None, default=None, to_dict=False, as_ordereddict=False):
        ...
        # Cast and return.
        if to_dict:
            return record.to_dict(conversion)
        elif as_ordereddict:
            return record.to_dict(conversion, ordered=True)
        else:
            return record
